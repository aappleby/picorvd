...
riscv64-unknown-elf-g++ -g -O0 -flto -ffunction-sections -static-libgcc -lgcc -march=rv32ec -mabi=ilp32e -I/usr/include/newlib -nostdlib -I. -Wall -T ch32v003fun.ld  -Wl,--gc-sections -o bin/blink.elf obj/ch32v003fun.o obj/blink.o -lgcc
